...
This paper presents our planning-based approach for the enumeration of alternative data-centric workflows.
Data-centric workflows are specified in ASASEL (Abstract State mAchineS Execution Language) based on the ASM formalism, and executed by the ASASEL enactment engine.
An ASASEL specification defines the coordination of data services and computing services for satisfying data requirements.
...
Together, our ASASEL language and enactment engine along with our enumeration approach provide the foundation for a highly flexible mechanism for managing data-centric workflows, business processes or eScience.
